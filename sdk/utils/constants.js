...
const errorDescriptions = {
  ...
  invalidState: 'Parámetro state inválido',
  invalidTokenType: 'Parámetro token_type inválido',
  invalidScope: 'Parámetro scope inválido',
  invalidExpiresIn: 'Parámetro expires_in inválido',
};
